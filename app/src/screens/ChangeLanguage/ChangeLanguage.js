    ...
    return (
        <View style={styles.container}>
            <View style={styles.header_view}>
                ...
                <Text style={styles.header_text}>Change Language</Text>
            </View>
            ...
            <View style={styles.button_view}>
                ...
                >
                    <Text style={styles.getstarted_text}>Change</Text>
                </TouchableOpacity>
            </View>
            <PopUpSuccessful successMessage="Language Changed Successfully!" visible={isPopupVisible} />
        </View>
    )
}
